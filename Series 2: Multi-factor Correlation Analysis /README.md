...
$AvgIC$ and $\mathit{IC_IR}$ of several factors are marked as NaN. This is because there is no monthly cross-section within the backtesting period satisfies the minimum sample-size requirement simultaneously.
